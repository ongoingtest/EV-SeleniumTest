...
class EnSetupUsersOrGroupsFunctionUsersGroupsChangePermissionsNetworkManager(unittest.TestCase):
    def setUp(self):
    ...
    def test_en_setup_users_or_groups_function_users_groups_change_permissions_network_manager(self):
        driver = self.driver
        ...
        try: self.assertEqual("on", driver.find_element_by_id("resetMediaPlayerPassword").get_attribute("value"))
        except AssertionError as e: self.verificationErrors.append(str(e))
        try: self.assertEqual("on", driver.find_element_by_id("lockUnlockDevice").get_attribute("value"))
        except AssertionError as e: self.verificationErrors.append(str(e))
        driver.find_element_by_id("networkManagerPermsChkBox").click()
        try: self.assertEqual("off", driver.find_element_by_id("networkManagerPermsChkBox").get_attribute("value"))
        except AssertionError as e: self.verificationErrors.append(str(e))
        try: self.assertEqual("off", driver.find_element_by_id("resetMediaPlayerPassword").get_attribute("value"))
        except AssertionError as e: self.verificationErrors.append(str(e))
        try: self.assertEqual("off", driver.find_element_by_id("lockUnlockDevice").get_attribute("value"))
        except AssertionError as e: self.verificationErrors.append(str(e))
        ...
        driver.find_element_by_id("userGroup_userGroupOptions173").click()
        driver.find_element_by_link_text("Network Manager").click()
        driver.find_element_by_id("lockUnlockDevice").click()
