...
class EnSetupUsersOrGroupsFunctionUsersGroupsChangePermissionsMediaManager(unittest.TestCase):
    def setUp(self):
    ...
    def test_en_setup_users_or_groups_function_users_groups_change_permissions_media_manager(self):
        driver = self.driver
        ...
        try: self.assertEqual("on", driver.find_element_by_id("uploadNewMedia").get_attribute("value"))
        except AssertionError as e: self.verificationErrors.append(str(e))
        try: self.assertEqual("on", driver.find_element_by_id("deleteMedia").get_attribute("value"))
        except AssertionError as e: self.verificationErrors.append(str(e))
        driver.find_element_by_id("mediaManagerPermsChkBox").click()
        try: self.assertEqual("off", driver.find_element_by_id("mediaManagerPermsChkBox").get_attribute("value"))
        except AssertionError as e: self.verificationErrors.append(str(e))
        try: self.assertEqual("off", driver.find_element_by_id("uploadNewMedia").get_attribute("value"))
        except AssertionError as e: self.verificationErrors.append(str(e))
        try: self.assertEqual("off", driver.find_element_by_id("deleteMedia").get_attribute("value"))
        except AssertionError as e: self.verificationErrors.append(str(e))
